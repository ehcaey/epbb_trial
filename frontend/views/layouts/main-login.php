...
<!-- <body class="login-page" style="background-color: red;"> -->
<body class="login-page" style="background: url(<?= Yii::getAlias('@web/images') ?>/gedung.jpg) no-repeat;background-size:cover;background-position: center;">
<div class="mask"></div>
<?php $this->beginBody() ?>
